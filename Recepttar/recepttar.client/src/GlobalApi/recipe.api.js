...
export async function searchRecipes(query = '', type = '') {
    ...
    const res = await axios.get('https://localhost:7035/api/recipe/search', { params });
...
export async function updateFavoriteState(recipeId) {
    ...
    const res = await axios.post(`https://localhost:7035/api/user/favorites/` + recipeId);
    return res.data;
}

export async function getLoginStatus() {
    return await axios.get('https://localhost:7035/api/user/profile');
}

export async function submitLogoutRequest() {
    return await axios.post('https://localhost:7035/api/user/logout');
}
...
export async function searchIngredients(search) {
    ...
    return await axios.get('https://localhost:7035/api/ingredient/search', { params });
}